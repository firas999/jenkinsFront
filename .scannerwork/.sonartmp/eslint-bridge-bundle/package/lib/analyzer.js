...
const function_calc_no_invalid_1 = require("./rules/stylelint/function-calc-no-invalid");
...
function analyzeCss(input) {
    ...
    stylelint.rules[function_calc_no_invalid_1.rule.ruleName] = function_calc_no_invalid_1.rule.rule;
    return stylelint
        .lint(options)
