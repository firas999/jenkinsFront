...
exports.rule = {
    ...
    create(context) {
        ...
        function isComparableTo(lhs, rhs) {
            ...
            const lhsType = checker.getBaseTypeOfLiteralType((0, utils_1.getTypeFromTreeNode)(lhs, services));
            const rhsType = checker.getBaseTypeOfLiteralType((0, utils_1.getTypeFromTreeNode)(rhs, services));
